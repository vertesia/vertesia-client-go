...
func (o *ProjectConfiguration) GetOauthClients() ProjectConfigurationOauthClients {
...
// and a boolean to check if the value has been set.
func (o *ProjectConfiguration) GetOauthClientsOk() (*ProjectConfigurationOauthClients, bool) {
	if o == nil || IsNil(o.OauthClients) {
		return nil, false
	}
...
func (o *ProjectConfiguration) HasOauthClients() bool {
	if o != nil && !IsNil(o.OauthClients) {
		return true
	}
...
func (o *ProjectConfiguration) SetOauthClients(v ProjectConfigurationOauthClients) {
	o.OauthClients = &v
}
