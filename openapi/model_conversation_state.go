...
type ConversationState struct {
	...
	ToolInputRefs map[string][]ExternalizedToolInputRef `json:"tool_input_refs,omitempty"`
...
// GetToolInputRefs returns the ToolInputRefs field value if set, zero value otherwise.
func (o *ConversationState) GetToolInputRefs() map[string][]ExternalizedToolInputRef {
	if o == nil || IsNil(o.ToolInputRefs) {
		var ret map[string][]ExternalizedToolInputRef
		return ret
	}
	return o.ToolInputRefs
}

// GetToolInputRefsOk returns a tuple with the ToolInputRefs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConversationState) GetToolInputRefsOk() (map[string][]ExternalizedToolInputRef, bool) {
	if o == nil || IsNil(o.ToolInputRefs) {
		return map[string][]ExternalizedToolInputRef{}, false
	}
	return o.ToolInputRefs, true
}

// HasToolInputRefs returns a boolean if a field has been set.
func (o *ConversationState) HasToolInputRefs() bool {
	if o != nil && !IsNil(o.ToolInputRefs) {
		return true
	}
...
// SetToolInputRefs gets a reference to the given map[string][]ExternalizedToolInputRef and assigns it to the ToolInputRefs field.
func (o *ConversationState) SetToolInputRefs(v map[string][]ExternalizedToolInputRef) {
	o.ToolInputRefs = v
}
...
func (o *ConversationState) GetAppVersion() string {
...
// and a boolean to check if the value has been set.
func (o *ConversationState) GetAppVersionOk() (*string, bool) {
	if o == nil || IsNil(o.AppVersion) {
		return nil, false
	}
...
func (o *ConversationState) HasAppVersion() bool {
	if o != nil && !IsNil(o.AppVersion) {
		return true
	}
...
func (o *ConversationState) SetAppVersion(v string) {
	o.AppVersion = &v
}
...
func (o ConversationState) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ToolInputRefs) {
		toSerialize["tool_input_refs"] = o.ToolInputRefs
	}
...
func (o *ConversationState) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ConversationState(varConversationState)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "tool_input_refs")
