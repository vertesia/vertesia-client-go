...
func (o *BedrockNovaOptions) unmarshalKnownJSON(data []byte) error {
	type plain BedrockNovaOptions
	return json.Unmarshal(data, (*plain)(o))
}

func (o *BedrockNovaOptions) UnmarshalJSON(data []byte) error {
	*o = BedrockNovaOptions{}
	var decoded BedrockNovaOptions
