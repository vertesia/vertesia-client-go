...
func NewRoleDefinition(name ProjectRoles, permissions []Permission) *RoleDefinition {
	this := RoleDefinition{}
	this.Name = name
...
func (o *RoleDefinition) GetName() ProjectRoles {
	if o == nil {
...
func (o *RoleDefinition) GetNameOk() (*ProjectRoles, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *RoleDefinition) SetName(v ProjectRoles) {
	o.Name = v
}
