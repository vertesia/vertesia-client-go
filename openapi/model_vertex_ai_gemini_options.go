...
func (o VertexAIGeminiOptions) ToMap() (map[string]interface{}, error) {
	...
	for key, value := range o.AdditionalProperties {
		if !modelOptionsIsKnownField(key, []string{"_option_id", "max_tokens", "temperature", "top_p", "top_k", "stop_sequence", "presence_penalty", "frequency_penalty", "seed", "effort", "include_thoughts", "thinking_budget_tokens", "thinking_level", "service_tier", "flex", "speech_voice", "speech_language", "transcription_language_codes", "transcription_diarization", "transcription_word_timestamps", "transcription_vocabulary", "image_aspect_ratio", "image_size", "person_generation", "prominent_people", "output_mime_type", "output_compression_quality"}) {
