...
func (o *Account) GetNamespace() string {
...
// and a boolean to check if the value has been set.
func (o *Account) GetNamespaceOk() (*string, bool) {
	if o == nil || IsNil(o.Namespace) {
		return nil, false
	}
...
func (o *Account) HasNamespace() bool {
	if o != nil && !IsNil(o.Namespace) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Account) GetAppAccessMessageOk() (*string, bool) {
	if o == nil || IsNil(o.AppAccessMessage) {
		return nil, false
	}
...
func (o *Account) HasAppAccessMessage() bool {
	if o != nil && !IsNil(o.AppAccessMessage) {
		return true
	}
...
func (o *Account) SetAppAccessMessage(v string) {
...
func (o *Account) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Account(varAccount)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "app_access_message")
