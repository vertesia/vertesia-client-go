...
func (dst *ModelOptions) UnmarshalJSON(data []byte) error {
	*dst = ModelOptions{}
	...
	case "openrouter-text":
		var branch OpenRouterTextOptions
		if err := json.Unmarshal(data, &branch); err != nil {
			return err
		}
		dst.OpenRouterTextOptions = &branch
		return nil
	case "openai-dalle":
	...
	case "openai-transcription":
		var branch OpenAiTranscriptionOptions
		if err := json.Unmarshal(data, &branch); err != nil {
			return err
		}
		dst.OpenAiTranscriptionOptions = &branch
		return nil
	case "openai-speech":
		var branch OpenAiSpeechOptions
		if err := json.Unmarshal(data, &branch); err != nil {
			return err
		}
		dst.OpenAiSpeechOptions = &branch
		return nil
	case "openai-audio":
		var branch OpenAiAudioOptions
		if err := json.Unmarshal(data, &branch); err != nil {
			return err
		}
		dst.OpenAiAudioOptions = &branch
		return nil
	case "xai-grok-image":
...
func (obj *ModelOptions) GetActualInstance() interface{} {
	...
	if obj.OpenAiAudioOptions != nil {
		return obj.OpenAiAudioOptions
	}
	...
	if obj.OpenAiSpeechOptions != nil {
		return obj.OpenAiSpeechOptions
	}
	...
	if obj.OpenAiTranscriptionOptions != nil {
		return obj.OpenAiTranscriptionOptions
	}
...
func OpenAiAudioOptionsAsModelOptions(v *OpenAiAudioOptions) ModelOptions {
	return ModelOptions{OpenAiAudioOptions: v}
}
...
func OpenAiSpeechOptionsAsModelOptions(v *OpenAiSpeechOptions) ModelOptions {
	return ModelOptions{OpenAiSpeechOptions: v}
}
...
func OpenAiTranscriptionOptionsAsModelOptions(v *OpenAiTranscriptionOptions) ModelOptions {
	return ModelOptions{OpenAiTranscriptionOptions: v}
}

func OpenRouterTextOptionsAsModelOptions(v *OpenRouterTextOptions) ModelOptions {
	return ModelOptions{OpenRouterTextOptions: v}
}
