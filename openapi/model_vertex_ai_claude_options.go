...
func NewVertexAIClaudeOptions() *VertexAIClaudeOptions {
...
func (o *VertexAIClaudeOptions) HasOptionId() bool {
	if o != nil && !IsNil(o.OptionId) {
		return true
	}
...
func (o *VertexAIClaudeOptions) unmarshalKnownJSON(data []byte) error {
	type plain VertexAIClaudeOptions
	return json.Unmarshal(data, (*plain)(o))
}

func (o *VertexAIClaudeOptions) UnmarshalJSON(data []byte) error {
	*o = VertexAIClaudeOptions{}
	var decoded VertexAIClaudeOptions
