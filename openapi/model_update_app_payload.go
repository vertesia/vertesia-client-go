...
func (o *UpdateAppPayload) GetOauthScopes() []string {
...
func (o *UpdateAppPayload) GetOauthScopesOk() ([]string, bool) {
	if o == nil || IsNil(o.OauthScopes) {
		return nil, false
	}
...
func (o *UpdateAppPayload) HasOauthScopes() bool {
	if o != nil && !IsNil(o.OauthScopes) {
		return true
	}
...
func (o *UpdateAppPayload) SetOauthScopes(v []string) {
	o.OauthScopes = v
}
