...
func NewBedrockGptOssOptions() *BedrockGptOssOptions {
...
func (o *BedrockGptOssOptions) HasOptionId() bool {
	if o != nil && !IsNil(o.OptionId) {
		return true
	}
...
func (o BedrockGptOssOptions) ToMap() (map[string]interface{}, error) {
	...
	for key, value := range o.AdditionalProperties {
		if !modelOptionsIsKnownField(key, []string{"_option_id", "max_tokens", "temperature", "top_p", "stop_sequence", "reasoning_effort", "frequency_penalty", "presence_penalty", "service_tier"}) {
...
func (o *BedrockGptOssOptions) unmarshalKnownJSON(data []byte) error {
	type plain BedrockGptOssOptions
	return json.Unmarshal(data, (*plain)(o))
}

func (o *BedrockGptOssOptions) UnmarshalJSON(data []byte) error {
	*o = BedrockGptOssOptions{}
	var decoded BedrockGptOssOptions
