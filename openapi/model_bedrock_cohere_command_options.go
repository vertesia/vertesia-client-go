...
func NewBedrockCohereCommandOptions() *BedrockCohereCommandOptions {
...
func (o *BedrockCohereCommandOptions) HasOptionId() bool {
	if o != nil && !IsNil(o.OptionId) {
		return true
	}
...
func (o *BedrockCohereCommandOptions) GetTopK() float32 {
...
// and a boolean to check if the value has been set.
func (o *BedrockCohereCommandOptions) GetTopKOk() (*float32, bool) {
	if o == nil || IsNil(o.TopK) {
		return nil, false
	}
	return o.TopK, true
...
func (o *BedrockCohereCommandOptions) HasTopK() bool {
	if o != nil && !IsNil(o.TopK) {
		return true
	}
...
func (o *BedrockCohereCommandOptions) SetTopK(v float32) {
	o.TopK = &v
}

// GetPresencePenalty returns the PresencePenalty field value if set, zero value otherwise.
func (o *BedrockCohereCommandOptions) GetPresencePenalty() float32 {
...
// and a boolean to check if the value has been set.
func (o *BedrockCohereCommandOptions) GetPresencePenaltyOk() (*float32, bool) {
	if o == nil || IsNil(o.PresencePenalty) {
		return nil, false
	}
...
func (o *BedrockCohereCommandOptions) HasPresencePenalty() bool {
	if o != nil && !IsNil(o.PresencePenalty) {
		return true
	}
...
func (o *BedrockCohereCommandOptions) SetPresencePenalty(v float32) {
	o.PresencePenalty = &v
}

// GetFrequencyPenalty returns the FrequencyPenalty field value if set, zero value otherwise.
func (o *BedrockCohereCommandOptions) GetFrequencyPenalty() float32 {
...
// and a boolean to check if the value has been set.
func (o *BedrockCohereCommandOptions) GetFrequencyPenaltyOk() (*float32, bool) {
	if o == nil || IsNil(o.FrequencyPenalty) {
		return nil, false
	}
...
func (o *BedrockCohereCommandOptions) HasFrequencyPenalty() bool {
	if o != nil && !IsNil(o.FrequencyPenalty) {
		return true
	}
...
func (o *BedrockCohereCommandOptions) SetFrequencyPenalty(v float32) {
...
func (o *BedrockCohereCommandOptions) GetIncludeThoughts() bool {
...
// and a boolean to check if the value has been set.
func (o *BedrockCohereCommandOptions) GetIncludeThoughtsOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeThoughts) {
		return nil, false
	}
...
func (o *BedrockCohereCommandOptions) HasIncludeThoughts() bool {
	if o != nil && !IsNil(o.IncludeThoughts) {
		return true
	}
...
func (o *BedrockCohereCommandOptions) SetIncludeThoughts(v bool) {
	o.IncludeThoughts = &v
}
...
func (o BedrockCohereCommandOptions) ToMap() (map[string]interface{}, error) {
	...
	for key, value := range o.AdditionalProperties {
		if !modelOptionsIsKnownField(key, []string{"_option_id", "max_tokens", "temperature", "top_p", "top_k", "presence_penalty", "frequency_penalty", "stop_sequence", "include_thoughts", "service_tier"}) {
...
func (o *BedrockCohereCommandOptions) unmarshalKnownJSON(data []byte) error {
	type plain BedrockCohereCommandOptions
	return json.Unmarshal(data, (*plain)(o))
}

func (o *BedrockCohereCommandOptions) UnmarshalJSON(data []byte) error {
	*o = BedrockCohereCommandOptions{}
	var decoded BedrockCohereCommandOptions
