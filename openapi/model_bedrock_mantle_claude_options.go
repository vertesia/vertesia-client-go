...
type _BedrockMantleClaudeOptions BedrockMantleClaudeOptions
...
func NewBedrockMantleClaudeOptions(optionId string) *BedrockMantleClaudeOptions {
...
func (o *BedrockMantleClaudeOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varBedrockMantleClaudeOptions := _BedrockMantleClaudeOptions{}

	err = json.Unmarshal(data, &varBedrockMantleClaudeOptions)

	if err != nil {
		return err
	}

	*o = BedrockMantleClaudeOptions(varBedrockMantleClaudeOptions)
