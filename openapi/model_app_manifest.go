...
func (o *AppManifest) GetOauthScopes() []string {
...
func (o *AppManifest) GetOauthScopesOk() ([]string, bool) {
	if o == nil || IsNil(o.OauthScopes) {
		return nil, false
	}
...
func (o *AppManifest) HasOauthScopes() bool {
	if o != nil && !IsNil(o.OauthScopes) {
		return true
	}
...
func (o *AppManifest) SetOauthScopes(v []string) {
	o.OauthScopes = v
}
